...
import edu.unicauca.reportes_SIVRI.reportes.infraestructura
        ...
        .ReporteTipoS01DTOPeticion;

@Component
public class ReporteTipoS01Strategy
        implements ReporteStrategy<ReporteTipoS01DTOPeticion> {
    ...
    public Map<String, Object> prepararParametros(
            List<ReporteTipoS01DTOPeticion> datos) {
        ...
        /*
         * La petición de S01 es una lista plana.
         * Cada objeto corresponde a un semillero.
         */
        parametros.put(
                "DATA_LIST",
                datos
    ...
    @Override
    public TypeReference<List<ReporteTipoS01DTOPeticion>>
            getTypeReference() {

        return new TypeReference<
                List<ReporteTipoS01DTOPeticion>>() {
        };
    }
