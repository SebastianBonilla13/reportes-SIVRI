...
public class GenerarReporteCUAdapter implements GenerarReporteCUIntPort {
    ...
    private final ObjectMapper objectMapper = new ObjectMapper().registerModule(new JavaTimeModule()); // cambiar logica de mapper?
    ...
    @Override
    public byte[] generarReporte(Object DTOReporte, String tipoReporte) {
        ...
        return ((ReporteStrategy<Object>) reporteStrategy).generarReporte(dtoEspecifico);
